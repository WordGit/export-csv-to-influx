...
class Configuration(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.field_columns_with_data_type = kwargs.get('field_columns_with_data_type', None)
        self.custom_field_value_type = kwargs.get('custom_field_value_type', False)
        ...
        self.field_columns_with_data_type = base_object.str_to_list(self.field_columns_with_data_type)
        self.custom_field_value_type = self.__validate_bool_string(self.custom_field_value_type)
